...
from marlkit.torch.dqn.ma_qcgraphqmix import DoubleDQNTrainer
from marlkit.torch.extra_networks import MlpHidden as Mlp
import marlkit.torch.pytorch_util as ptu
from marlkit.torch.mixers import VDNMixer, QMixer, QCGraphQmix
...
def experiment(variant):
    expl_env = MultiAgentEnv(env_wrapper(pursuit_v3.parallel_env()))
    eval_env = MultiAgentEnv(env_wrapper(pursuit_v3.parallel_env()))
...
def test():
    ...
    setup_logger(f"pursuit-base-qcgraphqmixmrl", variant=variant)
