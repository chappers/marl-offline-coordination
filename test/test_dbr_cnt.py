...
from marlkit.torch.sac.obtuse import OBTTrainer
...
from marlkit.launchers.launcher_util import setup_logger
from marlkit.samplers.data_collector import MdpPathCollector
from marlkit.torch.sac.policies import TanhGaussianPolicy, MakeDeterministic, VAEPolicy
from marlkit.torch.sac.obtuse import OBTTrainer
from marlkit.torch.networks import FlattenMlp
from marlkit.torch.torch_rl_algorithm import TorchBatchRLAlgorithm
...
def experiment(variant):
    ...
    expl_env = dtype_v0(gym.make("Pendulum-v0"), np.float32)
    eval_env = dtype_v0(gym.make("Pendulum-v0"), np.float32)
